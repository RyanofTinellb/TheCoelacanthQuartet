{
    "text": [
        ...
        "      </form>",
        "    </javascript>",
        "   <links-root>  <ul class=\"level-1\"><li><a href=\"thecrackledegg/index.html\">The Crackled Egg</a></li>",
        ...
        "                </no-breaks>",
        "                <no-breaks>",
        "                using the <a href=\"https://github.com/RyanofTinellb/Smeagol\">Sméagol</a> web editor.",
        "                </no-breaks>",
        "                <no-breaks>",
